...
Welcome to enovato.co! These Terms and Conditions ("Terms") govern your use of the enovato.co website and services (the "Service"). By accessing or using our Service, you agree to be bound by these Terms. If you do not agree with any part of these Terms, you must not use the Service.
...
- "Service" refers to the enovato.co platform, including all related software, applications, and services provided by enovato.co.
...
At enovato.co, we prioritize your privacy. We do not store your chat history on our servers. All chat history is stored locally on your device, and we do not have access to your personal conversations. By using the Service, you agree to this local storage and understand that you are responsible for securing your own data.
...
In no event shall enovato.co, its affiliates, or its licensors be liable for any indirect, incidental, special, consequential, or punitive damages, or any loss of profits or revenues, whether incurred directly or indirectly, or any loss of data, use, goodwill, or other intangible losses, resulting from:
...
You agree to indemnify, defend, and hold harmless enovato.co, its affiliates, and its licensors from and against any and all claims, damages, losses, liabilities, costs, and expenses arising from or related to your use of the Service or any violation of these Terms.
